...
public class Container {
    ...
    public static ArrayList<Sucursal> getSucursales(){
        ...
        sucursales.add(new Sucursal("Sede Norte", "Autopista norte #98-24", 4.68508, -74.05706, R.drawable.sucursal1));
        sucursales.add(new Sucursal("Sede Centro", "Calle 26 #33-16", 4.62992, -74.08242, R.drawable.sucursal2));
        ...
        sucursales.add(new Sucursal("Sede Occidente", "Avenida Boyacá #54-17", 4.67189, -74.10584, R.drawable.sucursal4));
